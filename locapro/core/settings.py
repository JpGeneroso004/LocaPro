...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'empresas.context_processors.tenant_context',
            ],
        },
    },
]
...
# Cloud Storage (AWS S3) - Pronto para Escalar SaaS
if env.bool('USE_S3', default=False):
    ...
    STORAGES = {
        ...
        "staticfiles": {
            "BACKEND": "django.contrib.staticfiles.storage.StaticFilesStorage", # Mantendo estáticos locais por performance, ou pode mudar para S3
        },
    }
...
# Configuração de Cache (LocalMem)
CACHES = {
    'default': {
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = '[LocaPro] '
